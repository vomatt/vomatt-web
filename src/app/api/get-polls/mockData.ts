...
export const mockPolls: Poll[] = [
	...
	},
	{
		...
		description:
			'With the team spanning multiple timezones, a text-based async standup via Slack might work better than a live call. What do you think?',
		active: true,
		votingActive: true,
		allowMultipleChoices: false,
		anonymous: false,
	...
	},
	{
		...
		updatedAt: ago(200),
		startTime: ago(300),
		endTime: ago(-2880), // 2 days from now
		totalVotes: 210,
		success: true,
		errorCode: null,
		options: [
